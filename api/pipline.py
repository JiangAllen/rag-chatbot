...
from core.service import azure_service
from core.llm_initial import model_application
from core.neo import Neo4jConnection
...
async def chatbot(input: InputData):
    ...
    def generate():
        for chunk in run_digitimes(input.history):
            yield chunk
